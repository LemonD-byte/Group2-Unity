...
namespace Enemies
{
    ...
    public abstract class EnemyBase : MonoBehaviour
    {
        ...
        protected virtual void Start()
        {
            ...
            // Định vị player ngay khi spawn - zombie đuổi theo ngay lập tức, không còn cơ chế
            // "phát hiện" (detect range) hay đứng Idle chờ player lại gần nữa.
        ...
        protected virtual void Update()
        {
            ...
            // Xử lý Tấn công hoặc Đuổi theo (luôn đuổi ngay từ khi spawn, không còn chờ phát hiện)
